import"chrome://downloads/strings.m.js";import{Polymer,dom,html,Base,afterNextRender,beforeNextRender,useShadow,Templatizer,OptionalMutableDataBehavior,animationFrame,microTask,idlePeriod,flush,Debouncer,enqueueDebouncer,matches,translate}from"chrome://resources/polymer/v3_0/polymer/polymer_bundled.min.js";import{isIOS,addSingletonGetter,isWindows,isMac,addWebUIListener,removeWebUIListener}from"chrome://resources/js/cr.m.js";import{loadTimeData}from"chrome://resources/js/load_time_data.m.js";import"chrome://resources/mojo/mojo/public/js/mojo_bindings_lite.js";import"chrome://downloads/downloads.mojom-lite.js";
/**
@license
        ...
        <template is="dom-if" if="[[showMenu]]" restamp="">
          ...
          <template is="dom-if" if="[[showMenuPromo]]">
            <div id="menuPromo" role="tooltip">
              [[menuPromo]]
              <button id="closePromo" on-click="onClosePromoTap_" aria-label$="[[closeMenuPromo]]">âœ•</button>
...
<cr-toolbar id="toolbar" page-name="Downloads" search-prompt="Search downloads" clear-label="Clear search" spinner-active="{{spinnerActive}}" on-search-changed="onSearchChanged_">
